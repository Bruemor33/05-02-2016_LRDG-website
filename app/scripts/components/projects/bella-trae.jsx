          ...
          <div id="main-nav" className="writeup">
            <div className="project-nav">
              ...
              <ul className="image-links">
                ...
                <li className="bella-list-item" role="button">
                  <Link activeClass="active" className="bella-two" to="bella-two" spy={true} smooth={true} duration={500}>

                  </Link>
                </li>

                <li className="bella-list-item" role="button">
                  <Link activeClass="active" className="bella-three" to="bella-three" spy={true} smooth={true} duration={500}>

                  </Link>
                </li>

                <li className="bella-list-item" role="button">
                  <Link activeClass="active" className="bella-four" to="bella-four" spy={true} smooth={true} duration={500}>

                  </Link>
                </li>

                <li className="bella-list-item" role="button">
                  <Link activeClass="active" className="bella-one" to="bella-one" spy={true} smooth={true} duration={500}>
