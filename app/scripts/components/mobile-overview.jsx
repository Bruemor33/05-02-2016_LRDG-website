...
var MobileOverviewComponent = React.createClass({
          ...
          <div className="row">
            <div className="mobile-practice-container col-md-12">
              <div className="mobile-overview-title">
                <div className="mobile-overview-logo"></div>
                <h2>Overview</h2>
              </div>
            </div>
          </div>
          <div className="row row-contain">
            <div className="mobile-statement-container col-md-12">
              <div className="scroller">
                ...
                <h4>What We Do</h4>
                <ul className="mobile-practice-services">
                  <li className="mobile-services-link-container">
...
//exports
module.exports = {
  'MobileOverviewComponent': MobileOverviewComponent
}
