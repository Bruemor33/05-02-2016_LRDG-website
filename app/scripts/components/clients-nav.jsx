...
var ClientsPageNavigation = React.createClass({
      ...
      <div className="container-fluid">
        <nav id="site-nav" className="row">
          <div className="projects-navigation col-md-12">
            ...
            <a href="#clients" id="clients-active" className="projects-clients">Clients</a>
...
//Component Export
module.exports = {
  'ClientsPageNavigation': ClientsPageNavigation
}
