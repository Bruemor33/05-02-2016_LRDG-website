...
var StudioPageComponent = React.createClass({
  ...
  barryClick: function(){
    $('#barry-toggle').slideToggle('slow');
  },

  scottClick: function(){
    $('#scott-toggle').slideToggle('slow');
  },

  jimClick: function(){
    $('#jim-toggle').slideToggle('slow');
  },
        ...
        <div className="row">
          <div className="studio-content-container col-md-12">
            <div className="barry col-md-4">
              <div onClick={this.barryClick} className="toggle-icon">
                <i className="fa fa-caret-square-o-down fa-2x" aria-hidden="true"></i>
              </div>
              <div className="barry-photo"></div>
              <div id="barry-toggle" className="barry-writeup">
            ...
            <div className="scott col-md-4">
              <div onClick={this.scottClick} className="toggle-icon">
                <i className="fa fa-caret-square-o-down fa-2x" aria-hidden="true"></i>
              </div>
              <div className="scott-photo"></div>
              <div id="scott-toggle" className="scott-writeup">
            ...
            <div className="jim col-md-4">
              <div onClick={this.jimClick} className="toggle-icon">
                <i className="fa fa-caret-square-o-down fa-2x" aria-hidden="true"></i>
              </div>
              <div className="jim-photo"></div>
              <div id="jim-toggle" className="jim-writeup">
